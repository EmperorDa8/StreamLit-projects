...
-experimenting with Google's latest AI model Gemini for simple tasks like image extraction, image Q/A, image classification, and others with its pre-trained models for
prompt output
